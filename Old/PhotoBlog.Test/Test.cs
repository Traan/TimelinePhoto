...
namespace TimelinePhotoOLD.Test
{
    [TestClass]
    public class Test
    {
        ...
        //                                Asset = new Asset()
        //                            });
        //    var apiController = new Controllers.PhotoController(repository: repository);

        //    var result = apiController.Get();

        //    Assert.AreEqual(result.date.First().headline, "TestEntry");
        //}
    }
